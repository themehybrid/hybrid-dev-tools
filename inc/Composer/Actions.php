...
class Actions {
    ...
    protected static array $tools = [
        'composer-normalize.phar' => [
            'url' => 'https://github.com/ergebnis/composer-normalize/releases/download/2.43.0/composer-normalize.phar',
            'ver' => '2.43.0',
        ],
        'php-scoper.phar'         => [
        ...
        'parallel-lint.phar'      => [
            'url' => 'https://github.com/php-parallel-lint/PHP-Parallel-Lint/releases/download/v1.4.0/parallel-lint.phar',
            'ver' => 'v1.4.0',
        ],
    ];
